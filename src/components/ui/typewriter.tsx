...
export function Typewriter({
  ...
  const currentColor = colors ? colors[currentTextIndex % colors.length] : undefined
  ...
  return (
    <span
      className={cn("inline whitespace-pre-wrap tracking-tight transition-colors duration-300", className)}
